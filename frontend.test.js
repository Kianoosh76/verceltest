...
// Read BASE_URL from command-line arguments
const BASE_URL = process.argv[2] || "http://localhost:3000"; // Default to http://localhost:3000 if not provided
...
describe("Task 3: Multi-section page layout", () => {
  ...
  it("Footer should exist and be responsive", async () => {
    ...
    const socialMediaLinksExists = await page.$("#footer .social-media-links");
